...
let sorular =[
    ...
    "c"),
    new Soru("2-Hangisi .net paket yönetim uygulamasıdır?",
    { a: "Node.js", b: "Nuget", c: "Npm" },
    "b"),
    new Soru(    "3-Hangisi React state yönetim uygulamasıdır?",
    { a: "Redux", b: "MobX", c: "Flux" },
    "a"
),
    new Soru( "4-Hangisi Vue.js yönetim uygulamasıdır?",
    { a: "Vuex", b: "React", c: "Angular" },
    "a")
]
